...
//        }
    ...
    public List<SubtitlesStream> getSubtitles(final MediaFormat format) throws ParsingException {
        ...
        boolean hasFoundPreferredAudioLanguage = false;
        ...
        for (int i = 0; i < captionsArray.size(); i++) {
            ...
            if (languageCode != null && baseUrl != null && vssId != null) {
                ...
                hasFoundPreferredAudioLanguage = hasFoundPreferredAudioLanguage
                        || languageCode.equals(preferredAudioLanguage);
        ...
        if (translatableSubtitle != null
                && !"original".equals(preferredAudioLanguage)
                && preferredAudioLanguage != null
                && !hasFoundPreferredAudioLanguage
                && ServiceList.YouTube.getShowAutoTranslatedSubtitles()) {
            if (!hasDuplicateEntries) {
                String autoTranslatedContent = SubtitleDeduplicator.getValidSubtitleContent(translatableSubtitle.getContent() + "&tlang=" + preferredAudioLanguage);
                if(autoTranslatedContent != null) {
                    subtitlesToReturn.add(new SubtitlesStream.Builder()
                            .setContent(autoTranslatedContent, false)
                            .setMediaFormat(format)
                            .setLanguageCode(preferredAudioLanguage)
