...
public class M3U8Parser {
    ...
    public static Map<String, List<String>> parseMasterM3U8(String masterContent, String cookies) {
        ...
        while (audioMatcher.find()) {
            ...
            parsedContent.computeIfAbsent("audio", k -> new ArrayList<>()).add(audioUrl + "#cookie=" + cookies);
        }
        ...
        while (videoMatcher.find()) {
            ...
            parsedContent.computeIfAbsent("video", k -> new ArrayList<>()).add(videoUrl + "#cookie=" + cookies);
        }
